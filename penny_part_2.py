...
df = pd.read_excel('datasets/penny_part_2/fed_diary_of_consumer_payment_choice/2025-diary-of-consumer-payment-choice-charts.xlsx',
                   sheet_name='Figure 4')
...
# lin reg for more data points to avoid low data errors - not advisable!
months_list = []
...
future_years = pd.date_range(start=f'{last_year+1}', periods=future_months, freq='ME')
